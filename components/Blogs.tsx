        ...
        >
          {slides.map((data: any, index: any) => (
            <a
              ...
              className="flex flex-col bg-gradient-to-b from-black to-[#AC9552] rounded-xl items-center gap-[5vh] lg:gap-[14vh] lg:w-[52vw] lg:h-[60vh] mx-auto pt-10 h-[55vh] w-[80%] no-underline"
            >
              <div>
                <h2 className="text-[#AC9552] text-white lg:text-4xl text-2xl text-center px-2">
                  {data.title}
                </h2>
              </div>
              <div className="w-[90%] h-[1px] bg-[#AC9552]"></div>
              <div>
                <p className="text-[#AC9552] text-white px-4 text-center text-sm lg:text-3xl text-justify">
                  {data.description}
                </p>
              </div>
            </a>
      ...
      <div className="hidden lg:flex flex-wrap justify-center items-start gap-8">
        {slides.map((slide, index) => (
          ...
          >
            ...
            <p className="text-justify text-[#AC9552] text-white text-lg text-center mx-4">
              {slide.description}
            </p>
          </a>
        ))}
