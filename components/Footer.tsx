...
<footer id="contact" className="bg-black rounded-lg shadow dark:bg-gray-900  ">
    <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <ul className="flex flex-wrap items-center mb-6 text-sm font-medium text-gray-500 sm:mb-0 dark:text-gray-400">
                ...
                <li>
                    <a href="#reviews" className="hover:underline me-4 md:me-6">Reviews</a>
                </li>
                <li>
                ...
                <div className="flex flex-col items-center justify-center gap-8 mb-3">
                    ...
                    <div className="flex gap-4 items-center">
                        ...
                        <p className="text-white  lg:text-2xl text-lg">6233 N California Ave, Chicago, IL 60659</p>
                    </div>
                </div>
