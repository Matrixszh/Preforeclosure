...
export default function Home() {
  ...
  return (
    <main>
      <div
        className={`flex gap-5 items-center z-20 fixed bottom-4 right-4 md:bottom-8 md:right-8 animate-pulse`}
      >
        <div className="overflow-hidden">
          <p
            className={`text-white text-md md:text-lg font-bold transition-all duration-300 ease-in-out ${
              isVisible
  ...
  >
    PREFORECLOSURES QUEEN
      ...
      <section className=" relative bg-white min-h-screen flex items-center justify-center flex-col">
        ...
        >
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            <h1 className="text-black text-center text-2xl lg:text-6xl">
              About Me
            </h1>
            <div className="h-[2px] w-16 bg-black "></div>
          </div>
      ...
      <section className="relative overflow-hidden  flex items-center justify-center flex-col gap-10">
        ...
        <div className="flex flex-col gap-8" id="event-content">
          ...
          >
            ...
            us and submit the short property information , we’ll give you a fair
            all-cash offer on your house within 24 hours… and the best part is:
            we can close whenever YOU choose to close – it’s entirely up to you.{" "}
            <span className="hidden md:flex md:pt-4">
              It doesn’t matter what condition the house is in, or even if there
              are tenants in there that you can’t get rid of… don’t worry about
              it. We’ll take care of it for you. And if you need the cash
              quickly, we can close in as little as 7 days because we buy houses
              with cash and don’t have to rely on traditional bank financing.
            </span>
          </p>
        </div>
      </section>
      <section
        id="meetups"
        className="scroll-mt-14  relative bg-White flex flex-col gap-10"
      >
        <div className="flex flex-col items-center gap-4 justify-center lg:justify-start pt-[5vh]">
          <p className="text-[#7C640E] text-center px-8 py-1 rounded-2xl text-sm tracking-wider">
        ...
        >
          ...
          learn, and grow. Our events focus on fostering meaningful
          relationships among like-minded individuals while providing valuable
          insights into real estate, particularly pre-foreclosures, and the
          power of mindset. Whether you’re a seasoned professional or just
          starting out, Chicago Meetups is the perfect place to network, share
          ideas, and unlock new opportunities. Join us and be part of a
          community where knowledge meets action, and ideas turn into success .
        </p>
      </section>
      <section
        id="reviews"
        className="scroll-mt-14 min-h-screen relative bg-White flex flex-col gap-10"
      >
        <div className="flex flex-col items-center gap-4 justify-center lg:justify-start pt-[5vh]">
          <p className="text-[#7C640E] text-center px-8 py-1 rounded-2xl text-sm tracking-wider">
            WHERE IDEAS MEET OPPORTUNITIES
      ...
      <section className="scroll-mt-14  relative bg-White flex flex-col gap-10 bg-black">
        <div className="flex flex-col items-center gap-4 justify-center lg:justify-start pt-[5vh]">
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            <h1 className="text-white text-center text-2xl lg:text-6xl">
              Collabs
            </h1>
            <div className="h-[2px] w-16 bg-[#7C640E] "></div>
          </div>
